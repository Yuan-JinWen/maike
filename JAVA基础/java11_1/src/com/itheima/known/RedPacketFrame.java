 ...
 *
 * @author xiaoliguang
 * RedPacketFrame表示红包界面,但是这个类是抽象类,我们要定义一个类继承这个抽象类
 */
public abstract class RedPacketFrame extends JFrame {
    ...
    private static JLabel input_bg_label = new JLabel(new ImageIcon("day11\\pic\\01_input.jpg"));
    static {
    ...
    private static JLabel open_label = new JLabel(new ImageIcon("day11\\pic\\02_open_2.gif"));
    private static JLabel open_bg_label = new JLabel(new ImageIcon("day11\\pic\\02_open_1.jpg"));
    static {
    ...
    private static JLabel show_bg_label = new JLabel(new ImageIcon("day11\\pic\\03_money_1.jpg"));
    ...
    private void initFrame() {
        // logo
        this.setIconImage(Toolkit.getDefaultToolkit().getImage("day11\\pic\\logo.gif"));
